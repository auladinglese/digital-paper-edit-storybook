...
class Transcript extends Component {
  ...
  componentDidMount = () => {
    props.getAllAnnotations(this.props.projectId, this.props.transcriptId)
  ...
  onLabelCreate = (newLabel) => {
    ...
    props.createLabel(this.props.projectId, newLabel)
  ...
  onLabelUpdate = (updatedLabel) => {
    ...
    props.updateLabel(this.props.projectId, updatedLabel.id, updatedLabel)
    // TODO: add error handling
      .then(json => {
        this.setState({
          labelsOptions: json.labels
  ...
  onLabelDelete = (labelIid) => {
    ...
    props.deleteLabel(this.props.projectId, labelIid)
    // TODO: add error handling
      .then(json => {
        this.setState({
          labelsOptions: json.labels
  ...
  handleCreateAnnotation = (e) => {
    ...
    if (selection) {
      ...
      props.createAnnotation(this.props.projectId, this.props.transcriptId, newAnnotation)
        .then(json => {
  ...
  handleDeleteAnnotation = (annotationId) => {
    ...
    props.deleteAnnotation(this.props.projectId, this.props.transcriptId, annotationId)
      .then(json => {
  ...
  handleEditAnnotation = (annotationId) => {
    ...
    if (newNote) {
      ...
      props.updateAnnotation(this.state.projectId, this.props.transcriptId, annotationId, newAnnotationToEdit)
        .then(json => {
